...
class TestJavaScriptASTParsing:
    ...
    def test_multiple_arguments_extraction(self, sample_javascript_code):
        ...
        expected_flags = {
            ...
            "new-dashboard",
            "complex-flag",
            "user123",  # user123 is extracted as designed
        }
    ...
    def test_multiple_flags_extraction(
        ...
        multi_flags = {
            ...
            "js-config-flag-2",
            "multi-flag-1",
            "multi-flag-2",  # from variable resolution
            "mixed-single",
            "mixed-multi-1",
            "mixed-multi-2",
        }
...
class TestJavaASTParsing:
    ...
    def test_multiple_flags_extraction(self, sample_java_multiple_flags_code):
        ...
        # Expected flags from single flag methods
        single_flags = {"java-single-flag", "java-single-feature"}
        ...
        multi_flags = {
            ...
            "java-config-flag-2",
            "java-list-flag-1",
            "java-list-flag-2",  # from variable resolution
            "java-mixed-single",
            "java-mixed-multi-1",
            "java-mixed-multi-2",
        }
...
"""
    ...
    def test_multiple_flags_extraction(
        ...
        # Expected flags from single flag methods
        single_flags = {"python-single-flag", "python-single-feature"}

        # Expected flags from multiple flag methods with lists
        multi_flags = {
            "python-multi-flag-1",
            "python-multi-flag-2",
            "python-context-flag-1",
            "python-context-flag-2",
            "python-config-flag-1",
            "python-config-flag-2",
            "python-list-flag-1",
            "python-list-flag-2",  # from variable resolution
            "python-mixed-single",
            "python-mixed-multi-1",
            "python-mixed-multi-2",
        }
...
class TestCSharpParsing:
    ...
    def test_multiple_flags_extraction(
        ...
        # Expected flags from single flag methods
        single_flags = {"csharp-single-flag", "csharp-single-feature"}

        # Expected flags from multiple flag methods with List<string>
        multi_flags = {
            "csharp-multi-flag-1",
            "csharp-multi-flag-2",
            "csharp-context-flag-1",
            "csharp-context-flag-2",
            "csharp-config-flag-1",
            "csharp-config-flag-2",
            "csharp-list-flag-1",
            "csharp-list-flag-2",  # from variable resolution
            "csharp-async-flag-1",
            "csharp-async-flag-2",
            "csharp-async-config-1",
            "csharp-async-config-2",
            "csharp-mixed-single",
            "csharp-mixed-multi-1",
            "csharp-mixed-multi-2",
        }
...
"""
        ...
        expected = {
            "python-flag-1",
            "python-flag-2",
            "direct-python-flag-1",
            "direct-python-flag-2",
        }
        assert expected.issubset(set(flags))
...
"""
    ...
    def test_comprehensive_async_csharp_variants(self):
        ...
        expected_async_flags = {
            ...
            "async-multi-1",
            "async-multi-2",
            "async-config-multi-1",
            "async-config-multi-2",
            "sync-flag",
            "mixed-async-1",
            "mixed-async-2",
        }
